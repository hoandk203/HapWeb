            ...
            <div className="accordion overflow-y-scroll" id="searchAccordion">
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#budgetCollapse">
                            Budget
                        </button>
                    </div>
                    <div id="budgetCollapse" className="accordion-collapse collapse show border-bottom">
                        <div className="accordion-body spacing-md">
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#ratingCollapse">
                            Rating
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#availabilityCollapse">
                            Availability
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#providerCollapse">
                            Provider type
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#serviceCollapse">
                            Service types
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#genderCollapse">
                            Gender
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#shiftCollapse">
                            Work shift
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#modeCollapse">
                            Service Mode
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#trainingCollapse">
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#proficiencyCollapse">
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#skillsCollapse">
                            Skills
                        </button>
                    </div>
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#experienceCollapse">
                ...
                <div className="accordion-item border-0">
                    <div className="accordion-header">
                        <button className="accordion-button bg-neutral-0 fs-14 fw-semibold shadow-none spacing-md pb-0" type="button" data-bs-toggle="collapse" data-bs-target="#industryCollapse">
                            Industries served
                        </button>
                    </div>
